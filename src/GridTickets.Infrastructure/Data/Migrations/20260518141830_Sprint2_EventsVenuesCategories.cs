...
{
    /// <inheritdoc />
    public partial class Sprint2_EventsVenuesCategories : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ticket_tiers_events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ticket_tiers_EventId",
                table: "ticket_tiers",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_ticket_tiers_IsDeleted",
                table: "ticket_tiers",
                column: "IsDeleted");
